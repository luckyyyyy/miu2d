        ...
        <div className="bg-[#252526] rounded-lg p-3">
          ...
          <div className="space-y-2 text-[#cccccc]">
            ...
            <div className="border-l-2 border-[#3c3c3c] pl-3 space-y-1">
              ...
              <p className="text-[#858585] mt-1">例：攻击者200闪避，目标100闪避 → 55% + 45% = <b>100%命中</b></p>
            </div>
        ...
        <div className="bg-[#252526] rounded-lg p-3">
          ...
          <div className="space-y-2 text-[#cccccc]">
            ...
            <div className="mt-2 space-y-1">
              <p>• <b>最低伤害</b>：5点（无论防御多高）</p>
              <p>• <b>护盾减伤</b>：部分武功可创建护盾抵消伤害</p>
              <p>• <b>免疫盾</b>：完全免疫所有伤害</p>
            </div>
      ...
      <div className="mt-4 bg-[#252526] rounded-lg p-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-[#cccccc]">
          <div>
            ...
            <p className="text-[#858585]">例：当前Lv5攻击50，升到Lv6，Lv6配置攻击60，Lv5配置攻击55</p>
            <p className="text-[#858585]">→ 新攻击 = 50 + (60 - 55) = <b>55</b></p>
          </div>
          <div className="space-y-1">
            <p>• <b>生命/体力/法力</b>：升级后自动恢复满</p>
            <p>• <b>攻击/防御</b>：基础值 + 装备加成</p>
            <p>• <b>闪避</b>：影响命中率计算</p>
    ...
    <div className="relative inline-block">
      ...
      {show && (
        <div className="absolute left-0 top-6 z-20 w-80 bg-[#1e1e1e] border border-[#454545] rounded-lg shadow-xl p-4 text-xs text-[#cccccc]">
          ...
          <p className="mb-2 text-[#858585]">升级时，属性按<b>增量</b>计算：</p>
          <code className="block bg-[#252526] p-2 rounded mb-2">
            新属性 = 当前属性 + (目标等级属性 - 当前等级属性)
          </code>
          <div className="space-y-1">
            <p><b>生命/体力/法力</b>：升级后自动恢复满</p>
            <p><b>攻击</b>：基础攻击 + 装备攻击加成</p>
            <p><b>防御</b>：基础防御 + 装备防御加成</p>
