...
export function FileTree({
  ...
  const [internalExpandedState, setInternalExpandedState] = useState<ExpandedState>(() => new Set(defaultExpanded));
  // 使用外部状态（受控模式）或内部状态
  ...
  // 拖拽经过
  const handleDragOver = useCallback((e: React.DragEvent, node: FlatFileTreeNode) => {
    // 处理内部拖拽或外部文件拖入
