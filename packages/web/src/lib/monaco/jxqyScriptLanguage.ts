...
export const SCRIPT_COMMANDS: Array<{
  ...
  // ===== NPC 命令 =====
  { name: "AddNpc", signature: "(npcFile, x, y, direction)", description: "在指定位置添加 NPC", category: "NPC" },
  { name: "LoadNpc", signature: "(npcFile)", description: "加载 NPC 配置文件", category: "NPC" },
  { name: "LoadOneNpc", signature: "(npcFile, x, y)", description: "加载单个 NPC 到位置", category: "NPC" },
  ...
  { name: "SetNpcPos", signature: "(name, x, y)", description: "设置 NPC 位置（瞬移）", category: "NPC" },
  { name: "SetNpcDir", signature: "(name, direction)", description: "设置 NPC 朝向 (0-7)", category: "NPC" },
  ...
  { name: "NpcGoto", signature: "(name, x, y)", description: "NPC 走到指定位置", category: "NPC", blocking: true },
  { name: "NpcGotoEx", signature: "(name, x, y)", description: "NPC 走到位置（非阻塞）", category: "NPC" },
  { name: "NpcGotoDir", signature: "(name, direction, steps)", description: "NPC 向方向走若干步", category: "NPC", blocking: true },
  { name: "SetNpcActionFile", signature: "(name, state, asfFile)", description: "设置 NPC 动画文件", category: "NPC" },
  { name: "NpcSpecialAction", signature: "(name, asfFile)", description: "播放 NPC 特殊动画", category: "NPC" },
  { name: "NpcSpecialActionEx", signature: "(name, asfFile)", description: "播放特殊动画（阻塞）", category: "NPC", blocking: true },
  { name: "ShowNpc", signature: "(name, show)", description: "显示/隐藏 NPC (1/0)", category: "NPC" },
  { name: "SetNpcScript", signature: "(name, scriptFile)", description: "设置 NPC 交互脚本", category: "NPC" },
  ...
  { name: "SetNpcRelation", signature: "(name, relation)", description: "设置 NPC 关系 (0友/1敌/2中立/3无)", category: "NPC" },
  { name: "Watch", signature: "(char1, char2, type)", description: "让角色面向另一角色", category: "NPC" },
  { name: "SetNpcKind", signature: "(name, kind)", description: "设置 NPC 类型 (0-7)", category: "NPC" },
  { name: "SetNpcMagicFile", signature: "(name, magicFile)", description: "设置 NPC 武功文件", category: "NPC" },
  { name: "SetNpcRes", signature: "(name, resFile)", description: "设置 NPC 资源文件", category: "NPC" },
  ...
  { name: "SetAllNpcScript", signature: "(name, scriptFile)", description: "设置所有同名 NPC 脚本", category: "NPC" },
  { name: "SetAllNpcDeathScript", signature: "(name, scriptFile)", description: "设置所有同名 NPC 死亡脚本", category: "NPC" },
  { name: "NpcAttack", signature: "(name, x, y)", description: "让 NPC 攻击位置", category: "NPC" },
  { name: "FollowNpc", signature: "(follower, target)", description: "让角色跟随另一角色", category: "NPC" },
  { name: "SetNpcMagicToUseWhenBeAttacked", signature: "(name, magic, dir)", description: "设置 NPC 反击武功", category: "NPC" },
  { name: "AddNpcProperty", signature: "(name, property, value)", description: "增加 NPC 属性值", category: "NPC" },
  { name: "ChangeFlyIni", signature: "(name, magicFile)", description: "改变 NPC 飞行武功", category: "NPC" },
  { name: "ChangeFlyIni2", signature: "(name, magicFile)", description: "改变 NPC 副飞行武功", category: "NPC" },
  { name: "AddFlyInis", signature: "(name, magicFile, distance)", description: "添加距离触发飞行武功", category: "NPC" },
  { name: "SetNpcDestination", signature: "(name, x, y)", description: "设置 NPC 目的地", category: "NPC" },
  { name: "GetNpcCount", signature: "(kind1, kind2)", description: "获取指定类型 NPC 数量→$NpcCount", category: "NPC" },
  { name: "SetKeepAttack", signature: "(name, x, y)", description: "设置 NPC 持续攻击位置", category: "NPC" },

  // ===== 玩家命令 =====
  { name: "SetPlayerPos", signature: "(x, y)", description: "设置玩家位置", category: "Player" },
  { name: "SetPlayerDir", signature: "(direction)", description: "设置玩家朝向 (0-7)", category: "Player" },
  { name: "SetPlayerState", signature: "(state)", description: "设置玩家状态", category: "Player" },
  { name: "PlayerGoto", signature: "(x, y)", description: "玩家走到位置", category: "Player", blocking: true },
  { name: "PlayerRunTo", signature: "(x, y)", description: "玩家跑到位置", category: "Player", blocking: true },
  { name: "PlayerGotoDir", signature: "(direction, steps)", description: "玩家向方向走若干步", category: "Player", blocking: true },
  { name: "PlayerGotoEx", signature: "(x, y)", description: "玩家走到位置（非阻塞）", category: "Player" },
  { name: "PlayerJumpTo", signature: "(x, y)", description: "玩家跳到位置", category: "Player", blocking: true },
  { name: "PlayerRunToEx", signature: "(x, y)", description: "玩家跑到位置（非阻塞）", category: "Player" },
  { name: "SetPlayerScn", signature: "()", description: "将摄像机居中到玩家", category: "Player" },
  { name: "AddGoods", signature: "(goodsName, count)", description: "添加物品", category: "Player" },
  { name: "AddRandGoods", signature: "(buyFileName)", description: "从商店文件随机添加物品", category: "Player" },
  { name: "DelGoods", signature: "(goodsName?, count?)", description: "删除物品", category: "Player" },
  { name: "EquipGoods", signature: "(equipType, goodsId)", description: "装备物品", category: "Player" },
  { name: "AddMoney", signature: "(amount)", description: "添加金钱", category: "Player" },
  { name: "AddRandMoney", signature: "(min, max)", description: "添加随机金钱", category: "Player" },
  ...
  { name: "SetMagicLevel", signature: "(magicFile, level)", description: "设置武功等级", category: "Player" },
  { name: "DelMagic", signature: "(magicFile)", description: "删除武功", category: "Player" },
  { name: "GetMoneyNum", signature: "($var?)", description: "获取金钱→$MoneyNum", category: "Player" },
  ...
  { name: "GetPlayerState", signature: "(stateName, $var)", description: "获取玩家属性值", category: "Player" },
  { name: "GetPlayerMagicLevel", signature: "(magicFile, $var)", description: "获取武功等级", category: "Player" },
  { name: "LimitMana", signature: "(enabled)", description: "限制内力使用 (1/0)", category: "Player" },
  { name: "AddMoveSpeedPercent", signature: "(percent)", description: "增加移动速度百分比", category: "Player" },
  ...
  { name: "UseMagic", signature: "(magicFile, x?, y?)", description: "使用武功", category: "Player" },
  { name: "IsEquipWeapon", signature: "($var)", description: "检查是否装备武器→1/0", category: "Player" },
  { name: "SetPlayerMagicToUseWhenBeAttacked", signature: "(magic, dir)", description: "设置玩家反击武功", category: "Player" },
  ...
  // ===== 对话命令 =====
  { name: "Say", signature: "(text, portraitIndex)", description: "显示对话框", category: "Dialog", blocking: true },
  { name: "Talk", signature: "(startId, endId)", description: "显示连续对话（从TalkIndex）", category: "Dialog", blocking: true },
  { name: "Choose", signature: "(msg, optA, optB, $var)", description: "显示二选一", category: "Dialog", blocking: true },
  { name: "Select", signature: "(msgId, optAId, optBId, $var)", description: "选择（使用TalkIndex文本）", category: "Dialog", blocking: true },
  { name: "Message", signature: "(text)", description: "显示系统消息", category: "Dialog" },
  { name: "DisplayMessage", signature: "(text)", description: "显示系统消息（别名）", category: "Dialog" },
  { name: "ShowMessage", signature: "(textId)", description: "显示TalkIndex消息", category: "Dialog" },
  { name: "ChooseEx", signature: "(msg, opt1, opt2, ..., $var)", description: "多选项选择（支持条件）", category: "Dialog", blocking: true },
  { name: "ChooseMultiple", signature: "(...)", description: "多选项选择", category: "Dialog", blocking: true },
  ...
  { name: "If", signature: "($var op value) @label", description: "条件跳转", category: "GameState" },
  ...
  { name: "Sleep", signature: "(milliseconds)", description: "暂停执行", category: "GameState", blocking: true },
  ...
  { name: "GetRandNum", signature: "($var, min, max)", description: "生成随机数", category: "GameState" },
  ...
  { name: "SetLevelFile", signature: "(file)", description: "设置等级配置文件", category: "GameState" },
  ...
  { name: "RunParallelScript", signature: "(scriptFile, delay?)", description: "并行运行脚本", category: "GameState" },
  ...
  { name: "PlayMovie", signature: "(movieFile)", description: "播放视频", category: "Audio", blocking: true },
  ...
  { name: "MoveScreen", signature: "(direction, distance, speed)", description: "移动摄像机", category: "Screen", blocking: true },
  { name: "MoveScreenEx", signature: "(x, y, speed)", description: "移动摄像机到位置", category: "Screen", blocking: true },
  { name: "ChangeMapColor", signature: "(r, g, b)", description: "改变地图颜色", category: "Screen" },
  { name: "ChangeAsfColor", signature: "(r, g, b)", description: "改变精灵颜色", category: "Screen" },
  ...
  { name: "ShowSnow", signature: "(show)", description: "显示/隐藏下雪 (1/0)", category: "Weather" },

  // ===== 物体命令 =====
  { name: "LoadObj", signature: "(objFile)", description: "加载物体配置文件", category: "Object" },
  { name: "AddObj", signature: "(objFile, x, y, direction)", description: "添加物体", category: "Object" },
  ...
  { name: "OpenObj", signature: "(objName?)", description: "打开物体动画（别名）", category: "Object" },
  { name: "CloseBox", signature: "(objName?)", description: "关闭箱子动画", category: "Object" },
  { name: "SetObjScript", signature: "(objName, scriptFile)", description: "设置物体脚本", category: "Object" },
  { name: "SaveObj", signature: "(fileName?)", description: "保存物体状态", category: "Object" },
  { name: "SetObjOfs", signature: "(objName, x, y)", description: "设置物体偏移", category: "Object" },

  // ===== 陷阱命令 =====
  { name: "SetTrap", signature: "(mapName, trapIndex, trapFile)", description: "设置地图陷阱（指定地图）", category: "Trap" },
  { name: "SetMapTrap", signature: "(trapIndex, trapFile)", description: "设置当前地图陷阱", category: "Trap" },
  ...
  { name: "AddToMemo", signature: "(memoId)", description: "添加记事（从TalkIndex）", category: "Memo" },
  ...
  { name: "SetTimeScript", signature: "(seconds, scriptFile)", description: "设置计时器触发脚本", category: "Timer" },

  // ===== 商店/物品扩展命令 =====
  { name: "BuyGoods", signature: "(buyFile, canSell?)", description: "打开购买界面", category: "Shop", blocking: true },
  { name: "SellGoods", signature: "(buyFile)", description: "打开出售界面", category: "Shop", blocking: true },
  { name: "BuyGoodsOnly", signature: "(buyFile)", description: "打开纯购买界面", category: "Shop", blocking: true },
  { name: "GetGoodsNum", signature: "(goodsFile)", description: "获取物品数量→$GoodsNum", category: "Shop" },
  { name: "GetGoodsNumByName", signature: "(goodsName)", description: "按名称获取物品数量", category: "Shop" },
  { name: "ClearGoods", signature: "()", description: "清空所有物品", category: "Shop" },
  { name: "ClearMagic", signature: "()", description: "清空所有武功", category: "Shop" },
  { name: "DelGoodByName", signature: "(name, count?)", description: "按名称删除物品", category: "Shop" },
  { name: "CheckFreeGoodsSpace", signature: "($var)", description: "检查物品栏空间→1/0", category: "Shop" },
  { name: "CheckFreeMagicSpace", signature: "($var)", description: "检查武功栏空间→1/0", category: "Shop" },
  { name: "SetDropIni", signature: "(name, dropFile)", description: "设置掉落配置", category: "Shop" },
  { name: "EnableDrop", signature: "()", description: "启用掉落", category: "Shop" },
  { name: "EnabelDrop", signature: "()", description: "启用掉落（原版拼写错误别名）", category: "Shop" },
  ...
  // ===== 变量扩展命令 =====
  { name: "ClearAllVar", signature: "(keep1, keep2, ...)", description: "清空变量（保留指定）", category: "Variable" },
  { name: "GetPartnerIdx", signature: "($var)", description: "获取同伴索引", category: "Variable" },

  // ===== 状态效果命令 =====
  { name: "PetrifyMillisecond", signature: "(ms)", description: "石化效果", category: "StatusEffect" },
  { name: "PoisonMillisecond", signature: "(ms)", description: "中毒效果", category: "StatusEffect" },
  { name: "FrozenMillisecond", signature: "(ms)", description: "冰冻效果", category: "StatusEffect" },

  // ===== 其他命令 =====
  { name: "ClearBody", signature: "()", description: "清除尸体", category: "Misc" },
  { name: "SetShowMapPos", signature: "(show)", description: "显示/隐藏地图坐标", category: "Misc" },
  { name: "ShowSystemMsg", signature: "(msg, stayTime?)", description: "显示系统消息", category: "Misc" },
  { name: "RandRun", signature: "($prob, script1, script2)", description: "随机运行脚本", category: "Misc" },
];
...
export function registerJxqyScriptLanguage(monaco: MonacoType): void {
  ...
  monaco.languages.registerHoverProvider(JXQY_SCRIPT_LANGUAGE_ID, {
    provideHover: (model: editor.ITextModel, position: Position) => {
      ...
      const cmd = SCRIPT_COMMANDS.find(
