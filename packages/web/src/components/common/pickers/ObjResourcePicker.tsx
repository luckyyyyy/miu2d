...
import { ObjPreview } from "../../../pages/dashboard/modules/obj/ObjPreview";
      ...
      >
        {value ? (
          <div className="flex items-center gap-2 flex-1 min-w-0">
            ...
            <LazyAsfIcon iconPath={selectedResource?.icon} gameSlug={gameSlug} size={20} prefix="asf/object/" fallback="📦" />
      ...
      >
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="flex items-center justify-between px-4 py-3 border-b border-[#454545] bg-[#252526]">
            ...
            <button type="button" onClick={onClose} className="p-1 rounded hover:bg-[#3c3c3c] text-[#808080] hover:text-white">
              ✕
            </button>
          </div>
                  ...
                  return (
                    ...
                    >
                      <div className="w-8 h-8 mr-2 flex-shrink-0 flex items-center justify-center">
                        <LazyAsfIcon iconPath={r.icon} gameSlug={gameSlug} size={28} prefix="asf/object/" fallback="📦" />
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <div className={`text-xs truncate ${isSelected ? "text-white/70" : "text-[#808080]"}`}>{r.key}</div>
                      </div>
                    </div>
                  );
                })}
          ...
          <div className="flex items-center justify-between px-4 py-3 border-t border-[#454545] bg-[#252526]">
            ...
            <div className="flex gap-2">
              <button type="button" onClick={onClose} className="px-4 py-2 text-sm rounded hover:bg-[#3c3c3c] text-[#cccccc]">
                取消
              </button>
              <button
                type="button"
        ...
        <div className="w-[280px] border-l border-[#454545] bg-[#252526] flex flex-col">
          ...
          <div className="flex-1 overflow-auto p-2">
            {selectedResource ? (
              <ObjResourcePreviewPanel gameId={gameId} gameSlug={gameSlug} resourceId={selectedResource.id} />
            ) : (
              <div className="flex items-center justify-center h-full text-[#555] text-xs">选择一个 OBJ 资源查看预览</div>
            )}
          </div>
        </div>
      </div>
