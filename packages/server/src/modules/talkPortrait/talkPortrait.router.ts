...
export class TalkPortraitRouter {
  ...
  async update(
    input: z.infer<typeof UpdatePortraitMapInputSchema>,
  ...
  async importFromIni(
    input: z.infer<typeof ImportPortraitMapInputSchema>,
    @Ctx() ctx: AuthenticatedContext
  ) {
  ...
  async clearAll(
    input: z.infer<typeof ClearAllTalkPortraitsInputSchema>,
    @Ctx() ctx: AuthenticatedContext
  ) {
