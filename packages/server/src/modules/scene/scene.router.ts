...
export class SceneRouter {
  ...
  async list(input: z.infer<typeof ListSceneInputSchema>, @Ctx() ctx: AuthenticatedContext) {
    return sceneService.list(input, ctx.userId, ctx.language);
  }

  @UseMiddlewares(requireUser)
  @Query({ input: GetSceneInputSchema, output: SceneSchema.nullable() })
  async get(input: z.infer<typeof GetSceneInputSchema>, @Ctx() ctx: AuthenticatedContext) {
  ...
  async create(input: z.infer<typeof CreateSceneInputSchema>, @Ctx() ctx: AuthenticatedContext) {
    return sceneService.create(input, ctx.userId, ctx.language);
  }

  @UseMiddlewares(requireUser)
  @Mutation({ input: UpdateSceneInputSchema, output: SceneSchema })
  async update(input: z.infer<typeof UpdateSceneInputSchema>, @Ctx() ctx: AuthenticatedContext) {
  ...
  async delete(input: z.infer<typeof DeleteSceneInputSchema>, @Ctx() ctx: AuthenticatedContext) {
