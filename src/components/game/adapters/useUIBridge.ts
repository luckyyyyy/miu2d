...
// ============= 细粒度 Hooks (可选) =============
// 这些 hooks 直接接受 UIBridgeResult 或 IUIBridge，避免重复获取 bridge
 ...
 */
export function useUIMemos(result: UseUIBridgeResult | null): readonly import("@/engine/ui/contract").UIMemoEntry[] | null {
