...
import { GAME_FONTS } from "../../engine/gui/fonts";
...
export const TitleGui: React.FC<TitleGuiProps> = ({
  ...
  // 背景图路径
  const backgroundUrl = `/resources/${UI_CONFIG.background}`;
  ...
  const handlers: Record<string, () => void> = useMemo(() => ({
    begin: onNewGame,
    load: onLoadGame,
    team: onTeam || (() => console.log("Team credits")),
    exit: onExit || (() => console.log("Exit game")),
      ...
      <div style={containerStyle}>
        ...
        <div
          style={{
            ...
            right: 0,
            textAlign: "center",
            fontFamily: GAME_FONTS.system,
            fontSize: 10,
            color: "rgba(255,255,255,0.3)",
          }}
        >
          Web Remake · Based on JxqyHD Engine
        </div>
      </div>
    </div>
  );
