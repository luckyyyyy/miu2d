...
export class Good {
  ...
  get kind(): GoodKind { return this.data.kind; }
  get intro(): string { return this.data.intro; }
  get imagePath(): string { return this.data.imagePath; }
  get iconPath(): string { return this.data.iconPath; }
  get part(): EquipPosition { return this.data.part; }

  get life(): number { return this.data.life; }
  get thew(): number { return this.data.thew; }
  get mana(): number { return this.data.mana; }
  get lifeMax(): number { return this.data.lifeMax; }
  get thewMax(): number { return this.data.thewMax; }
  get manaMax(): number { return this.data.manaMax; }
  get attack(): number { return this.data.attack; }
  get attack2(): number { return this.data.attack2; }
  get attack3(): number { return this.data.attack3; }
  get defend(): number { return this.data.defend; }
  get defend2(): number { return this.data.defend2; }
  get defend3(): number { return this.data.defend3; }
  get evade(): number { return this.data.evade; }

  get effectType(): number { return this.data.effectType; }
  get specialEffect(): number { return this.data.specialEffect; }
  get specialEffectValue(): number { return this.data.specialEffectValue; }

  get script(): string | undefined { return this.data.script; }
  get flyIni(): string | undefined { return this.data.flyIni; }
  get flyIni2(): string | undefined { return this.data.flyIni2; }
  get magicIniWhenUse(): string | undefined { return this.data.magicIniWhenUse; }

  get cost(): number { return this.data.cost || this.calculateCost(); }
  get sellPrice(): number { return this.data.sellPrice || Math.floor(this.cost / 2); }

  get user(): string[] | undefined { return this.data.user; }
  get minUserLevel(): number { return this.data.minUserLevel; }
  get noNeedToEquip(): number { return this.data.noNeedToEquip; }

  get addMagicEffectPercent(): number { return this.data.addMagicEffectPercent; }
  get addMagicEffectAmount(): number { return this.data.addMagicEffectAmount; }
  get changeMoveSpeedPercent(): number { return this.data.changeMoveSpeedPercent; }
  get coldMilliSeconds(): number { return this.data.coldMilliSeconds; }
  ...
  private calculateCost(): number {
    switch (this.kind) {
      case GoodKind.Drug:
        return (this.thew * 4 + this.life * 2 + this.mana * 2) *
          (1 + (this.effectType === 0 ? 0 : 1));
      case GoodKind.Equipment:
        if (this.noNeedToEquip > 0) return 0;
        return (
          this.attack * 20 + this.attack2 * 20 + this.attack3 * 20 +
          this.defend * 20 + this.defend2 * 20 + this.defend3 * 20 +
          this.evade * 40 +
...
function parseEquipPosition(value: string): EquipPosition {
  switch (value.toLowerCase()) {
    case 'head': return EquipPosition.Head;
    case 'neck': return EquipPosition.Neck;
    case 'body': return EquipPosition.Body;
    case 'back': return EquipPosition.Back;
    case 'hand': return EquipPosition.Hand;
    case 'wrist': return EquipPosition.Wrist;
    case 'foot': return EquipPosition.Foot;
    default: return EquipPosition.None;
  }
}
  ...
  for (const line of lines) {
    ...
    switch (key.toLowerCase()) {
      case 'name':
        ...
        break;
      case 'kind':
        data.kind = parseInt(value) as GoodKind;
        break;
      case 'intro':
        data.intro = value;
        break;
      case 'effect':
        data.effect = parseInt(value) || 0;
        break;
      case 'image':
      ...
      case 'part':
        ...
        break;
      case 'life':
        data.life = parseInt(value) || 0;
        break;
      case 'thew':
        data.thew = parseInt(value) || 0;
        break;
      case 'mana':
        data.mana = parseInt(value) || 0;
        break;
      case 'lifemax':
        data.lifeMax = parseInt(value) || 0;
        break;
      case 'thewmax':
        data.thewMax = parseInt(value) || 0;
        break;
      case 'manamax':
        data.manaMax = parseInt(value) || 0;
        break;
      case 'attack':
        data.attack = parseInt(value) || 0;
        break;
      case 'attack2':
        data.attack2 = parseInt(value) || 0;
        break;
      case 'attack3':
        data.attack3 = parseInt(value) || 0;
        break;
      case 'defend':
        data.defend = parseInt(value) || 0;
        break;
      case 'defend2':
        data.defend2 = parseInt(value) || 0;
        break;
      case 'defend3':
        data.defend3 = parseInt(value) || 0;
        break;
      case 'evade':
        data.evade = parseInt(value) || 0;
        break;
      case 'effecttype':
        data.effectType = parseInt(value) || 0;
        break;
      case 'specialeffect':
        data.specialEffect = parseInt(value) || 0;
        break;
      case 'specialeffectvalue':
        data.specialEffectValue = parseInt(value) || 1;
        break;
      case 'script':
        data.script = value;
        break;
      ...
      case 'magiciniwhenuuse':
        ...
        break;
      case 'cost':
        data.cost = parseInt(value) || 0;
        break;
      case 'sellprice':
        data.sellPrice = parseInt(value) || 0;
        break;
      case 'user':
        data.user = value.split(',').map(s => s.trim()).filter(s => s);
        break;
      case 'minuserlevel':
        data.minUserLevel = parseInt(value) || 0;
        break;
      case 'noneedtoequip':
        data.noNeedToEquip = parseInt(value) || 0;
        break;
      case 'addmagiceffectpercent':
        data.addMagicEffectPercent = parseInt(value) || 0;
        break;
      case 'addmagiceffectamount':
        data.addMagicEffectAmount = parseInt(value) || 0;
        break;
      case 'changemovespeedpercent':
        data.changeMoveSpeedPercent = parseInt(value) || 0;
        break;
      case 'coldmilliseconds':
        data.coldMilliSeconds = parseInt(value) || 0;
        break;
    }
  }
...
export async function getGood(fileName: string): Promise<Good | null> {
  ...
  console.warn(`[Good] Could not find: ${fileName}`);
  return null;
}
