...
import { getEngineContext } from "@/engine/core/engineContext";
...
export class GoodsListManager {
  ...
  exchangeListItem(index1: number, index2: number): void {
    ...
    if (index1 !== index2 && this.indexInRange(index1) && this.indexInRange(index2)) {
      ...
      console.log('[GoodsListManager] exchangeListItem: calling onUpdateView, callback exists:', !!this.onUpdateView);
      this.onUpdateView?.();
    }
  }
